...
$revillageRoot = Join-Path $projectsRoot "Ecrire\ouvrages\ReVillage\Tome 1"
$revillageMetadataSource = Join-Path $revillageRoot 'metadata.yml'
$revillageCoverSource = Join-Path $revillageRoot 'img\couverture.png'
